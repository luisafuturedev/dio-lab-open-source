...
COMMIT E SEU SIGNIFICADO - FEITO COM O GIT PARA ESTE OPEN SOURCE DO GITHUB.

FEAT >>> nova funcionalida ao projeto.

FIX >>>  corrige bug ou problema.

DOCS >>> altera a documentação do projeto (comentários e um README.

STYLE >>> muda o estilo/aparência sem prejudicar na experiência.

REFACTOR >>> mudança no código.

TEST >>> adiona e modifica testes do projeto.
